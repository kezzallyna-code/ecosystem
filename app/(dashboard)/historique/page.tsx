...
export default function Historique() {
  ...
  const tableData = [
    { date: "12/05/2024 14:32", sensor: "SOL-B-04", subtitle: "Humidité sol", site: "Ferme Mitidja", value: "39.2%", network: 3, battery: 1, status: "Optimal" },
    { date: "12/05/2024 14:30", sensor: "TEMP-A-01", subtitle: "Température air", site: "Ferme Mitidja", value: "26.4°C", network: 2, battery: 1, status: "Optimal" },
    { date: "12/05/2024 14:28", sensor: "PH-C-03", subtitle: "Acidité (pH)", site: "Ferme Mitidja", value: "6.8", network: 3, battery: 1, status: "Neutre" },
    { date: "12/05/2024 14:25", sensor: "WATER-01", subtitle: "Niveau Cuve", site: "Ferme Mitidja", value: "78%", network: 1, battery: 0, status: "Alerte Seuil" },
  ];
      ...
      <Card className={styles.filterCard} padding="lg">
        <div className={styles.filtersGrid}>
          ...
          <div className={styles.filterItem}>
            ...
            <Select id="site" options={[{ value: 'mitidja', label: 'Ferme intelligente Mitidja' }]} />
          </div>
          <div className={styles.filterItem}>
      ...
      <div className={styles.mainContent}>
        <Card className={styles.tableCard} padding="none">
                    ...
                    <td>
                      <div className={styles.networkIcons}>
                        <span className={styles.signalIcon}>
                          {row.network === 3 ? '📶' : row.network === 2 ? '📶' : '📶'} {/* Simplified representation */}
                        </span>
          ...
          <div className={styles.pagination}>
            <div className={styles.pageInfo}>Affichage de 1-4 sur 1,284 entrées</div>
        ...
        <div className={styles.sideContent}>
          <Card className={styles.evolutionCard} padding="lg">
            ...
            <div className={styles.chartArea}>
              {/* CSS visual placeholder for the chart */}
